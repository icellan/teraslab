...
/// while [`crate::cluster::shards::ShardTable::compute_with_epoch`] sorts a local
...
impl TopologyAuthority {
    ...
    /// stale-table gate (`coordinator::stale_table_may_serve_shard`, private so
    /// not linkable) depends on for a serving decision.
